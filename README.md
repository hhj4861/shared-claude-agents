...
│   ├── qa/                    # QA팀
│   │   ├── _orchestrator.md   # QA 디렉터 (파이프라인 총괄)
│   │   ├── step1-doc-collector.md   # 문서 수집자
│   │   ├── step2-code-analyzer.md   # 코드 분석자
│   │   ├── step3-scenario-writer.md # 시나리오 작성자
...
│   - search_filters, forms, messages 추출                            │
...
│   - docs/qa/latest/test-results/screenshots/ 에 스크린샷 저장       │
└─────────────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────┐     ┌──────────────────────┐     ┌─────────────────────┐
│  skills/*.md    │ →   │  _orchestrator.md    │ →   │  step*-*.md         │
│  (진입점)        │     │  (라우팅)             │     │  (실행 로직)         │
└─────────────────┘     └──────────────────────┘     └─────────────────────┘
```
...
| `agents/qa/_orchestrator.md` | 라우팅 | 요청을 적절한 step 에이전트로 분배 |
